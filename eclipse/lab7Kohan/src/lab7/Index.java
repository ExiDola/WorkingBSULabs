...
public class Index implements Serializable, Closeable {
    ...
    IndexOne2One IdepartmentNumber;
    IndexOne2N IfullName;
    IndexOne2N IhireDate;

    public void test(Employee employee) throws NotUniqueExcep {
        assert (employee != null);
        if (IfullName.contains(employee.fullName)) {
            throw new NotUniqueExcep(employee.employeeId);
        }
    }

    public void put(Employee employee, long value) throws NotUniqueExcep {
        test(employee);
        IdepartmentNumber.put(employee.employeeId, value);
        IfullName.put(employee.fullName, value);
        IhireDate.put(employee.fullName, value);
    }

    public Index() {
    	IdepartmentNumber = new IndexOne2One();
    	IfullName = new IndexOne2N();
    	IhireDate = new IndexOne2N();
    }
